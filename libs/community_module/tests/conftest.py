"""Shared fixtures for community_module tests.
...
``community_module.features`` and ``flask_core.*`` submodules import
...
# --- libs/ on sys.path (module-package tests, e.g. community_module.features) ---
