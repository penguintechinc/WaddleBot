"""Shared fixtures for event_module tests.
...
``event_module.features`` and ``flask_core.*`` submodules import without
...
# --- libs/ on sys.path (module-package tests, e.g. event_module.features) ---
