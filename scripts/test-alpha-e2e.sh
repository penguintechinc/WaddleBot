...
#
# Usage:
#   ./scripts/test-alpha-e2e.sh                 # Test alpha (default)
#
set -uo pipefail
...
HOST_HEADER=""
CURL_OPTS="-sk --resolve waddlebot.localhost.local:443:127.0.0.1 --resolve waddlebot.localhost.local:80:127.0.0.1"
...
echo ""
echo -e "${BLUE}═══════════════════════════════════════════════${NC}"
echo -e "${BLUE}  WaddleBot E2E API Tests — alpha${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════${NC}"
