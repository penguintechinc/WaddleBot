...
class Config:  # noqa: E302
    ...
    def load_credentials_from_db(cls, db_connection) -> bool:
        ...
        try:
            rows = db_connection.executesql(
                ...
                "WHERE platform = 'browser_source_core' "
            ...
            if rows and rows[0]:
                ...
                logger.info(
                    "Credentials loaded from platform_integrations for browser_source_core"
                )
                return True
    ...
    def start_credential_listener(cls, redis_client) -> Optional[threading.Thread]:
        ...
        channel = "credentials:browser_source_core:bot:refreshed"
