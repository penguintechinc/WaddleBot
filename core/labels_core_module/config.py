...
class Config:
    ...
    MODULE_PORT = int(os.getenv('MODULE_PORT', '8023'))
    ...
    def load_credentials_from_db(cls, db_connection) -> bool:
        ...
        try:
            ...
            if rows and rows[0]:
                ...
                logger.info(
                    "Credentials loaded from platform_integrations for labels_core"
                )
                return True
    ...
    def start_credential_listener(cls, redis_client) -> Optional[threading.Thread]:
        ...
        channel = "credentials:labels_core:bot:refreshed"
