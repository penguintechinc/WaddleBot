"""Configuration for memories_interaction_module"""
import logging
import os
import threading
...
class Config:
    ...
    MODULE_PORT = int(os.getenv('MODULE_PORT', '8031'))
    ...
    def load_credentials_from_db(cls, db_connection) -> bool:
        ...
        try:
            rows = db_connection.executesql(
                ...
                "WHERE platform = 'memories_interaction' "
            ...
            if rows and rows[0]:
                ...
                logger.info(
                    "Credentials loaded from platform_integrations for memories_interaction"
                )
                return True
