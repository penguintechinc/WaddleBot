...
class Config:
    ...
    def load_credentials_from_db(cls, db_connection) -> bool:
        """Load Spotify credentials from platform_integrations table.
        ...
        try:
            ...
            if rows and rows[0]:
                ...
                logger.info(
                    "Spotify credentials loaded from platform_integrations"
                )
                return True
    ...
    def start_credential_listener(cls, redis_client) -> Optional[threading.Thread]:
        ...
        channel = "credentials:spotify:bot:refreshed"
