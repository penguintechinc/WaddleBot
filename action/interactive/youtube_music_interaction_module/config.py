"""Configuration for youtube_music_interaction_module"""
import logging
import os
import threading
...
class Config:
    """YouTube Music module configuration from environment variables."""
    ...
    def load_credentials_from_db(cls, db_connection) -> bool:
        """Load YouTube Music credentials from platform_integrations table.
        ...
        try:
            ...
            if rows and rows[0]:
                ...
                logger.info(
                    "YouTube Music credentials loaded from platform_integrations"
                )
                return True
