"""
Configuration module for Teams Action Module.
...
class Config:
    ...
    # Teams API Configuration (env var fallback, overridden by DB)
    ...
    _raw_db_url = os.getenv(
        "DATABASE_URL",
        "postgresql://mod_action_teams:mod_action_teams_dev_changeme"
    ...
    CREDENTIAL_CHANNEL: str = "credentials:teams:bot:refreshed"
    ...
    REST_PORT: int = int(os.getenv("REST_PORT", "8074"))
    ...
    def get_info(cls) -> dict:
        ...
        return {
            ...
            "has_teams_app_id": bool(cls.TEAMS_APP_ID),
            "has_teams_app_password": bool(cls.TEAMS_APP_PASSWORD),
