...
class AppConstants {
  ...
  static String licenseServerFeaturesUrl =
      'https://license.penguintech.io/api/v2/features';
  static String licenseServerKeepaliveUrl =
      'https://license.penguintech.io/api/v2/keepalive';
  ...
  static const int licenseOfflineGracePeriodMs =
